            ...
            <tbody>
            	<c:if test="${not empty listSearch}">
            		<c:forEach items="${listSearch}" var="objLand">
            			<c:set value="${pageContext.request.contextPath}/admin/land/edit/${objLand.lid}" var="urlEdit"></c:set>
            			...
            			<tr class="odd gradeX">
		                    ...
		                    <td class="center text-center">
		                        ...
		                        <a href="${urlDelete}" title="Xóa" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Xóa</a>
		                    </td>
		                </tr>
            		</c:forEach>
            	</c:if>
                <c:if test="${empty listSearch}">
                	<tr>
                		<td colspan="6"><h5 style="text-align: center;">Từ khóa bạn tìm kiếm không có</h5></td>
                	</tr>
                </c:if>
            </tbody>
        </table>
