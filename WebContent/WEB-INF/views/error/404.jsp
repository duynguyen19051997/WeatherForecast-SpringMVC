...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="${pageContext.request.contextPath}/adminUrl/https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js"></script>
    <script src="${pageContext.request.contextPath}/adminUrl/https://oss.maxcdn.com/libs/respond.js/1.4.2/respond.min.js"></script>
<![endif]-->
</head>
    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <h4 class="text-muted m-t-30 m-b-30">Bạn không có quyền truy cập vào trang này</h4>
                <a href="${pageContext.request.contextPath}/admin" class="btn btn-danger btn-rounded waves-effect waves-light m-b-40">Back to home</a> </div>
        </div>
        <!-- ============================================================== -->
        <!-- Login box.scss -->
        <!-- ============================================================== -->
